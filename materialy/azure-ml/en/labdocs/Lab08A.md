...
3. In the JupyterLab file browser, open the `MachineLearningCourse/materialy/azure-ml/en` folder you cloned in [Lab 1B](Lab01B.md), and then open the **08A - Tuning Hyperparameters.ipynb** notebook. Then read the notes in the notebook, running each code cell in turn.
